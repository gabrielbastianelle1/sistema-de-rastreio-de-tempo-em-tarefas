...
public class ListTasksTest extends TaskTest {
    ...
    private final Collection<Task> tasks = new ArrayList<>() {
        {
            add(new Task.Builder(1, null, LocalDateTime.of(2023, 01, 05, 12, 0, 0), user)
                    .withEndDate(LocalDateTime.of(2023, 01, 05, 14, 0, 0)).build());
            add(new Task.Builder(2, null, LocalDateTime.of(2023, 01, 06, 12, 0, 0), user)
                    .withEndDate(LocalDateTime.of(2023, 01, 06, 14, 30, 0)).build());
        }
    };
