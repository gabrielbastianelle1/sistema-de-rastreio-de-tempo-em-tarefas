...
// public void testSuccess(Class<? extends UseCase<Boolean>> clazz) throws
// Exception {
// UseCase<Boolean> associateTask =
// clazz.getDeclaredConstructor(TaskRepository.class, Task.class, Project.class)
...
// clazz.getDeclaredConstructor(TaskRepository.class, Task.class, Project.class)
// .newInstance(repository, task, project);
// when(task.getProject()).thenReturn(new Project.Builder(null,
// mock(User.class), "test project").build());
